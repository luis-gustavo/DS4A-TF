...
```{r}
file.info('data/geociencias.graph.json')
```
...
Os arquivos `r data/Geografia.graph.json`, `r data/geociencias.graph.json` e `r data/geologia.graph.json` apresentam redes de colaboração na co-autoria de artigos científicos, feitas entre os docentes vinculados a programas de pós-graduação de Geografia, Geociências e Geologia da UnB, entre 2010 e 2017.
