...
```{r}
unb.gegrafia.pub <- fromJSON("data/Geografia.publication.json")
names(unb.gegrafia.pub)
```
...
```{r}
length(unb.gegrafia.pub$PERIODICO$`2017`)
names(unb.gegrafia.pub$PERIODICO$`2017`)
sort(table(unb.gegrafia.pub$PERIODICO$`2017`$periodico), decreasing = TRUE)

length(unb.gegrafia.pub$LIVRO$`2017`)
names(unb.gegrafia.pub$LIVRO$`2017`)
sort(table(unb.gegrafia.pub$LIVRO$`2017`$pais_de_publicacao), decreasing = TRUE)
```
